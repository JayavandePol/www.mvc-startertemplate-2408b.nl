-- Step: 01
     ...
     ,Prijs              DECIMAL(6,2)                NOT NULL
     ,IsActief           BIT                         NOT NULL        DEFAULT 1
     ,Opmerking          VARCHAR(200)                    NULL        DEFAULT NULL
     ,DatumAangemaakt    DATETIME(3)                 NOT NULL
     ,DatumGewijzigd     DATETIME(3)                 NOT NULL
     ...
     VALUES
     ('Nike', 'Air Jordan 1', 'Basketbal', 189.99, 1, NULL, SYSDATE(6), SYSDATE(6)),
